...
%the alpha variable contains my chosen theta the other thetas (theta1,theta2,..)
%is just trials 
alpha = 0.003;
num_iters = 1800;
...
legend('alpha of 0.003','alpha of 0.1','alpha of 1');


% Display gradient descent's result
fprintf('Theta computed from gradient descent using alpha of 0.003: \n');
fprintf(' %f \n', theta);
fprintf('\n');
